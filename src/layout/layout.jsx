...
import { getSettings } from "../pages/Account/api/settings";
import { getAccountData } from "../pages/Account/api/account";
...
export const Layout = () => {
  ...
  return (<>
    {user &&
      <div className="sticky top-0 z-40 bg-primary text-white w-full px-4">
